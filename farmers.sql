...
('work', 'work@gmail.com', 3, 'silk', 'silk is best business developed from coocon for saries preparation and so on', 582);

-- --------------------------------------------------------

update `addagroproducts` set `price`=500 where `productname`='GIRIJA CAULIFLOWER';
...
(1, '2', 'FARMER UPDATED', '2024-03-25 23:04:44'),
(2, '2', 'FARMER DELETED', '2024-03-25 23:04:58'),
(3, '8', 'Farmer Inserted', '2024-03-25 23:16:52'),
(4, '8', 'FARMER UPDATED', '2024-03-25 23:17:17'),
(5, '8', 'FARMER DELETED', '2024-03-25 23:18:54');
...
(5, 'dsatm', 'dsatm@gmail.com', 'pbkdf2:sha256:150000$TfhDWqOr$d4cf40cc6cbfccbdcd1410f9e155ef2aa660620b0439a60c4d74085dbf007a4a');
